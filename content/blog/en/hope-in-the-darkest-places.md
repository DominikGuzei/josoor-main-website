...
“Down” is four floors underground, and is equipped with the latest tools for the most effective torture techniques. Nobody gets out without confessing to everything they are alleged to have done, and they are ready to kill for that. To them, it’s a matter of principle that nobody can withstand the state power by not submitting, so they will continue until, sooner or later, you confess - otherwise you end up dead, or worse, in [Sednaya.](https://saydnaya.amnesty.org)
