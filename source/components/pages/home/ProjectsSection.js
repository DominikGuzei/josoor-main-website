            ...
            <Row around="xs">
              <Col xs={12} sm={10} md={5} lg={4} className={`${styles.project} ${styles.connect}`}>
                <Row center="xs">
                  ...
                  <Col xs={12} sm={10} className={styles.info}>
                    Where refugees and supporters connect and build strong, active and inclusive communities
                  </Col>
                </Row>
              </Col>
              <Col xs={12} sm={10} md={5} lg={4} className={`${styles.project} ${styles.answers}`}>
                <Row center="xs">
                  ...
                  <Col xs={12} sm={10} className={styles.info}>
                    Where refugees and supporters bridge the language barrier and exchange tustworthy information
                  </Col>
                </Row>
              </Col>
            </Row>
